...
--CONSTRAINT ChargeDate CHECK (ChargeDate = PostingDate)
		)
...
/*    creating view to get a list of members name complet address, phone and email address 
...
/*    Creating TVF Function  to find a list of members who has birthday on a specific month    
